$( document ).ready( function() {
	...
	$sItem.on( 'click', function( e ){
		...
		if ( $( this ).hasClass( 'products' ) ) {
			...
			if ( !$( '#menu-item-397' ).find( 'ul.sub-menu:first' ).hasClass( 'open' ) ) {

				$( '#menu-item-397' ).find( 'ul.sub-menu:first' ).addClass( 'open' );
			}
			...
			if ( !$( '#menu-item-428' ).find( 'ul.sub-menu:first' ).hasClass( 'open' ) ) {

				$( '#menu-item-428' ).find( 'ul.sub-menu:first' ).addClass( 'open' );
			}
		}
