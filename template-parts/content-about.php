...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    <section class="main-content p60">
        ...
        <?php if ( get_field( 'about_section_title' ) || get_field( 'about_items' ) ) : ?>
                ...
                <div class="constrain">
                    ...
                    <?php if ( have_rows( 'about_items' ) ) : ?>
                        <div class="flexxed">
                            ...
                            <?php $itemCount = count( get_field( 'about_items' ) ); ?>
                            <?php while ( have_rows( 'about_items' ) ) : the_row(); ?>
                                <div class="media-item items-<?php echo $itemCount; ?>">
                                    ...
                                    <div class="media-item-text">
                                        ...
                                        <a href="<?php the_sub_field( 'item_link' ); ?>" class="chevron-left">Read More</a>
                                    </div>
                                </div>
                            <?php endwhile; ?>
                        </div><!-- .flexxed -->
